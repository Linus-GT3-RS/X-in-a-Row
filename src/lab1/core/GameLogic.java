...
import lab1.comms.ICommunicator;
import lab1.comms.JSONGameHandler;
import lab1.comms.PeerFactory;
import lab1.comms.UDPCommunicator;
import lab1.comms.UDPMsgType;
...
public class GameLogic {
	...
	public List<Cell> isPointScored(int r, int c) {
		Direction[] directions = Direction.values();
		int targetCell = field.getCell(r, c);	// found cells have to match this one
	...
	private void startPlayerConsoleThread() {
	...
	public void processGameCommand(SelectCellCommand cmd) {
		...
		List<Cell> cellsInRow = isPointScored(cmd.r(), cmd.c());
		if(cellsInRow != null) {			
